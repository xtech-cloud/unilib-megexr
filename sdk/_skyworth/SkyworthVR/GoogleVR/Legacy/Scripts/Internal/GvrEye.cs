...
public class GvrEye : MonoBehaviour
{
    ...
    // C# stereo rendering is not used when HAS_GOOGLEVR is true and this is running on a device.
...
#pragma warning restore 649
    ...
    void OnPreCull()
    {
        ...
        bool doStereoEffect = false;// GvrViewer.Instance.StereoScreen != null;
#if UNITY_IOS
