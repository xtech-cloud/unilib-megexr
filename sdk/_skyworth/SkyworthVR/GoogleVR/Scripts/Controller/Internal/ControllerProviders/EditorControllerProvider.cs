...
namespace Gvr.Internal {
  ...
  class EditorControllerProvider : IControllerProvider {
    ...
    ControllerState emulatorState = new ControllerState( SvrControllerIndex.SVR_CONTROLLER_INDEX_RIGHT);
    ControllerState mouseState = new ControllerState(SvrControllerIndex.SVR_CONTROLLER_INDEX_RIGHT);
